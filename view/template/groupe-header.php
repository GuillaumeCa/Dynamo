<section class="sec sec-bg-overlay">
  ...
  <div class="auto-width group">
    ...
    <?php if ($isLeader): ?>
      <a href="#" class="button btn-sm btn-right" id="InfoModifier" onclick="editInfo(this,'.edit-content','.edit-form')"><?php lang('modifier'); ?></a>
    <?php endif; ?>

    <?php if ($isInGroup==0): ?>
      <form action="" method="post">
        <button type="submit" class="button btn-sm btn-right" name="autoinv"><?php lang('submit'); ?></button>
      </form>
    <?php endif; ?>
